...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['career-capsule-admin', 'college-admin', 'reviewer', 'student'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'College', path: '/colleges', entity: 'college', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Review', path: '/reviews', entity: 'review', service: AccessServiceEnum.PROJECT, icon: FiEdit },
