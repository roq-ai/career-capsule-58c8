...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Career Capsule Admin'];
  const customerRoles: string[] = ['Student'];
  const tenantRoles: string[] = ['College Admin', 'Career Capsule Admin', 'Reviewer', 'Student'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Career Capsule`;
